...
class Member(models.Model):
    ...
    # New Project Fields
    company_projects = models.TextField(verbose_name="Company Projects", blank=True, null=True, help_text="Describe your company's projects")
    project_images = models.ImageField(upload_to='project_images/', verbose_name="Project Images", blank=True, null=True, help_text="Upload project images")
    ...
    redan_reg_number = models.CharField(max_length=50, verbose_name="REDAN Reg. Number", blank=True, null=True)
