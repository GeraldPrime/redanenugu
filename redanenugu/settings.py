"""
Django settings for redanenugu project.
...
SECRET_KEY = 'django-insecure-r00ohqs2n!63^(v4@f#&tt03+b^gdbmuzo-^@@9%*elrzmmq--'
...
MIDDLEWARE = [
    ...
    'portal.middleware.SecretaryAdminMiddleware',  # Add this line
]

ROOT_URLCONF = 'redanenugu.urls'
...
# Add logging configuration for email debugging
LOGGING = {
    'version': 1,
